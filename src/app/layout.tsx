...
export const metadata: Metadata = {
  title: 'Mert Sukusu - Personal Blog',
  description: 'Software Developer & Test Automation Specialist',
}
          ...
          <footer className="py-8 border-t border-navy-100">
            <div className="container mx-auto px-4 flex flex-col items-center justify-center space-y-4">
              <div className="flex items-center space-x-6">
                ...
                <a
                  href="https://www.linkedin.com/in/mert-sukusu/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-navy-600 hover:text-navy-900 transition-colors"
                >
              ...
              <p className="text-navy-600 text-center font-medium">
